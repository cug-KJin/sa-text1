...
public class ProducerDemo {
    public ProducerDemo(String Massage){
        ...
        try{
            ...
            message.setMessageBody("demo_message_body" + Massage); // use your own message body here
            Message putMsg = queue.putMessage(message);
            System.out.println("Send message id is: "+ Massage + putMsg.getMessageId());
    ...
    public static void main(String[] args) {
        ProducerDemo p = new ProducerDemo("消息3");
    }
